                                            ...
                                            ?>                                                
                                                ...
                                                <div id="drag_<?php echo $stop->pos; ?>" class="drag-area row" data-pos="<?php echo $stop->pos; ?>">
                                                    ...
                                                    <div class="form-group col-lg-3">
                                                        <label for="from" class="col-sm-2 control-label" style="line-height: 35px;">parada:</label>
                                                        <div class="col-sm-10">
                                                    ...
                                                    <div class="form-group col-lg-2">
                                                        <label for="to" class="col-sm-3 control-label" style="line-height: 35px;">Precio:</label>
                                                        <div class="col-sm-6">
                                                    ...
                                                    <div class="form-group col-lg-2">
                                                        <label for="to" class="col-sm-3 control-label" style="line-height: 35px;">Recogida En:</label>
                                                        <div class="col-sm-6">
                                                    ...
                                                    <div class="form-group col-lg-3">
                                                        ...
                                                        <label for="to" class="col-sm-2 control-label" style="line-height: 35px;">Hora:</label>
